...
- **Save Location**: Always output your final document to `production_artifacts/{FEATURE_ID}/Technical_Specification.md`.
...
1. **Analyze Requirements**: Deeply analyze the user's initial idea request.
   Dérive un `FEATURE_ID` court en snake_case (max 20 chars) depuis le titre du projet.
